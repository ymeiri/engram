...
| PR release/CI follow-up | T285-T287 fixed PR CI failures and checkout runtime warnings. Current PR #2 head `93bc2428a452edf9c19322e9a63b7b1c757b52f2` passed exact-head CI run `27077943994` across Check, Format, Docs, Clippy, and Test. T302 marks the PR ready and merges it to `main` as `71fd746402c7d63f8b5aa758bc2011796819b5f6`. PR #3 head `6c86012b08126d02f33be1865fd78d55e2939a4e` passed exact-head CI run `27080135030` before T304 release-metadata edits. | Closed for phase-0 beta release. T304 and future phase-1 pushes require their own local validation and exact-head CI before PR readiness, merge, or tagging. |
