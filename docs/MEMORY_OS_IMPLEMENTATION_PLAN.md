...
Node 24. T287 is not PR readiness; it requires a fresh PR CI run on the T287 head, and that pass
should be recorded in Engram memory/handoff rather than by creating another docs-only CI recursion.

Current T287 matrix snapshot:
