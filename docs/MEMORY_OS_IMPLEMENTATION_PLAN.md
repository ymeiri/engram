...
- [x] Direct unified `search` continuation prompts prioritize scoped `current-plan` MemoryItems
      ...
      current-plan memory first in trace `019e68a5-ef05-7db0-8249-3722fcf78aea`.
