...
T59 matrix note: `docs/BRAIN_HARNESS_T59_M6_REVIEW_EXPORT_SCOPE_PROPOSAL_2026-05-31.md` prepares
the next approval question for exactly one `memory(action="migration_review_export", ...)` call
