...
README/MCP setup docs now state the beta host-scope caveat. The T299 commit still requires its own
exact-head PR CI before beta readiness can be claimed.

Current T299 matrix snapshot:
