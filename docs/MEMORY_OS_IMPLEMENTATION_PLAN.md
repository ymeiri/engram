...
| Memory quality / lifecycle | Partially validated | Review-gated promotion, archive-aware retrieval, stale-target cleanup, document lifecycle dogfood, Codex adapter follow-through, lint reports | Existing lint still reports duplicate entity candidates and old handoff/missing-evidence warnings with no safe automatic action. |
