...
This is development-diff validation on top of head `4d67e5a`; after this guard is committed, rerun
exact-head hosted CI and the GA gate before tag, publish, or Homebrew tap update.
